...
*/
#define EXAMPLE_WIFI_SSID "Cityscape"
#define EXAMPLE_WIFI_PASS "applejuice500"
...
//        ESP_LOGI(TAG, "%s", rx_buffer);
        ...
        long micros_elapsed = now - last_pkt_micros;
        last_pkt_micros = now;
        if (micros_elapsed > 50000) {
          OpcHeader* h = (OpcHeader*) rx_buffer;
          ESP_LOGI(TAG, "%f %04x", micros_elapsed / 1000., htons(h->sequenceNs));
        }
